...
const HEADERS = {
  ...
  'Content-Security-Policy': [
    "default-src 'self' https://unpkg.com https://api.chucknorris.io https://www.metaweather.com  'unsafe-inline'",
    "connect-src 'self' https://api.chucknorris.io https://cors-anywhere.herokuapp.com/https://www.metaweather.com/api/location/ 'unsafe-inline'",
    "img-src 'self' https://assets.chucknorris.host 'unsafe-inline'",
...
const urlFormatter = url => {
  if (url.length === 133 && url.startsWith('/emailSender/'))
    url = '/linkPassword';
